      ...
      <div className="flex min-h-screen items-center justify-center bg-surface-2 px-4">
        <div className="premium-card w-full max-w-md p-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {signedInEmail} does not have store-owner access. Sign in with the Audiony admin email.
          </p>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface-2 px-4">
      <form onSubmit={submit} className="premium-card w-full max-w-md p-8">
        ...
        <h1 className="mt-4 text-center font-display text-2xl font-bold">Audiony Admin</h1>
        ...
        <div className="mt-6 space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="audionygadgetspk@gmail.com"
            />
          </div>
          <div className="space-y-1.5">
