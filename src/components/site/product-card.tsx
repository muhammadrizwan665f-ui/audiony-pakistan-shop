  ...
  return (
    ...
    >
      <div className="absolute left-3 top-3 z-10 flex flex-col gap-1.5">
        {off > 0 ? (
          <span className="gradient-brand rounded-full px-2.5 py-1 text-xs font-bold text-brand-foreground shadow-soft">
            -{off}%
          </span>
        ) : null}
        {product.flashSale ? (
      ...
      <div className="flex flex-1 flex-col gap-3 p-4">
        ...
        <div>
          ...
          <p className="mt-1.5 text-xs text-muted-foreground">
            Only <span className="font-semibold text-destructive">{product.stock}</span> left in stock
          </p>
        </div>
