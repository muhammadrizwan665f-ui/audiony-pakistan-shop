...
export const Route = createFileRoute("/shop")({
  ...
  head: () => ({
    meta: [
      { title: "Shop All Gadgets — Audiony Gadgets Pakistan" },
      {
        name: "description",
        content:
          "Browse all Audiony wireless earbuds, bluetooth headphones, solar lights and CX20 mobile cooling fans with live stock and flash sale pricing.",
      },
      { property: "og:title", content: "Shop All Gadgets — Audiony Gadgets" },
      {
    ...
    <div className="mx-auto max-w-7xl px-4 py-12">
      ...
      <div className="mt-8 flex flex-col gap-4 sm:flex-row">
        <Input
          ...
          placeholder="Live search: earbuds, CX20, solar..."
