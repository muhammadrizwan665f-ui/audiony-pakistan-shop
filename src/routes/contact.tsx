...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact & Support — Audiony Gadgets" },
      {
        name: "description",
        content:
          "Message the Audiony Gadgets support team on WhatsApp, phone or email for orders, warranty and returns anywhere in Pakistan.",
      },
      { property: "og:title", content: "Contact & Support — Audiony Gadgets" },
