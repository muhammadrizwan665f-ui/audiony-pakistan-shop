...
export const Route = createFileRoute("/order/$orderId")({
  head: ({ params }) => ({
    meta: [
      { title: `Order ${params.orderId} — Audiony Gadgets` },
      { name: "description", content: "Your Audiony Gadgets order confirmation and status." },
      { property: "og:title", content: "Order confirmation — Audiony Gadgets" },
