...
export const Route = createFileRoute("/track")({
  head: () => ({
    meta: [
      { title: "Track Your Order — Audiony Gadgets" },
      {
        name: "description",
        content: "Enter your Audiony Gadgets order ID to see live status and tracking updates.",
      },
      { property: "og:title", content: "Track Your Order — Audiony Gadgets" },
      { property: "og:description", content: "Live order status for every Audiony delivery." },
