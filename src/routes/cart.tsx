...
export const Route = createFileRoute("/cart")({
  head: () => ({
    meta: [
      { title: "Your Cart — Audiony Gadgets" },
      {
        name: "description",
        content:
          "Review your Audiony Gadgets cart, apply coupon codes, see bulk quantity discounts and continue to checkout.",
      },
      { property: "og:title", content: "Your Cart — Audiony Gadgets" },
    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-24 text-center">
        ...
        <p className="mt-3 text-muted-foreground">
          Add a gadget and unlock bulk discounts from 2 pieces onwards.
        </p>
        ...
        <aside className="premium-card h-fit p-6 lg:sticky lg:top-28">
          ...
          >
            <Input
              ...
              placeholder="Promo code (try AZADI14)"
              maxLength={24}
          ...
          <ul className="mt-5 space-y-2 text-xs text-muted-foreground">
            ...
            <li className="flex items-center gap-2">
              <ShieldCheck className="size-4 text-primary" /> Secure checkout & warranty included
            </li>
          </ul>
        </aside>
      </div>
